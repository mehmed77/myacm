            ...
            foreach($this->standings_list as $key => $value){
                ...
                print"
                 <tr>
                    ...
                    <td class='text-center'><a href='".URL."profile/user/".$value['login']."'>".$value['fname']." ".$value['name']." { ".$value['login']." }</a></td>
...
<div align="center">
    <nav style="margin-top: -20px;">
        <ul class="pagination">
            <li>
                <a href="<?php print URL."problemset/standings/$Previous"; ?>" aria-label="Previous">
            ...
            for($i = $next; $i <= $last; $i++){
                if($this->stan_page == $i){
                    print "<li class=\"active\"><a href=".URL."problemset/standings/".$i.">$i</a></li>";
                }else{
                    print "<li><a href=".URL."problemset/standings/".$i.">$i</a></li>";
                }
            }
            ?>
            <li>
                <a href="<?php print URL."problemset/standings/".($this->stan_page+1) ?>" aria-label="Next">
